...
export function AnalysisSection({ lot, onCreateAnalysis, onViewAnalysis }: AnalysisSectionProps) {
  const analysisTypes = [
          ...
          <div className="space-y-4">
            <div className="bg-green-50 border border-green-200 rounded-lg p-4">
              ...
              <div className="grid grid-cols-2 gap-3">
                <div
                  className="bg-white border border-green-300 rounded p-3 cursor-pointer hover:bg-green-50 transition-colors"
                  onClick={() => onViewAnalysis?.("pureza-fisica")}
                >
