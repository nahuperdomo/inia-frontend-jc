  ...
  return (
    <Card>
      <CardHeader className="px-4 sm:px-6 py-4 sm:py-6">
        ...
        <CardDescription className="text-sm">Complete la información del lote en las siguientes pestañas</CardDescription>
      </CardHeader>
      <CardContent className="px-4 sm:px-6">
        <Tabs value={activeTab} onValueChange={onTabChange} className="w-full">
          <TabsList className="grid w-full grid-cols-2 sm:grid-cols-4 h-auto">
            ...
            <TabsTrigger value="recepcion" className="text-xs sm:text-sm py-2 whitespace-normal sm:whitespace-nowrap">
              <span className="hidden sm:inline">Recepción y almacenamiento</span>
              <span className="sm:hidden">Recepción</span>
            </TabsTrigger>
            <TabsTrigger value="calidad" className="text-xs sm:text-sm py-2 whitespace-normal sm:whitespace-nowrap">
          ...
          {/* Datos Tab */}
          <TabsContent value="datos" className="space-y-4 mt-4 sm:mt-6">
          ...
          <TabsContent value="recepcion" className="space-y-4 mt-4 sm:mt-6">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
              <FormField
                id="fechaEntrega"
          ...
          <TabsContent value="calidad" className="space-y-4 mt-4 sm:mt-6">
            <>
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
                <FormField
                  id="kilosLimpios"
