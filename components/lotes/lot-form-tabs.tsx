    ...
    <Card>
      <CardHeader className="p-4 sm:p-6">
        ...
        <CardDescription className="text-xs sm:text-sm">
          Complete la información del lote en las siguientes pestañas
        </CardDescription>
      </CardHeader>
      <CardContent className="p-3 sm:p-4 md:p-6">
        <Tabs value={activeTab} onValueChange={onTabChange} className="w-full">
          <TabsList className="grid w-full grid-cols-2 sm:grid-cols-4 h-auto gap-1 sm:gap-0">
            <TabsTrigger value="datos" className="text-xs sm:text-sm px-2 py-2 sm:px-3">
              <span className="hidden xs:inline">Datos</span>
              <span className="xs:hidden">Datos Generales</span>
            </TabsTrigger>
            <TabsTrigger value="empresa" className="text-xs sm:text-sm px-2 py-2 sm:px-3">
              <span className="hidden xs:inline">Empresa</span>
              <span className="xs:hidden">Empresa</span>
            </TabsTrigger>
            <TabsTrigger value="recepcion" className="text-xs sm:text-sm px-2 py-2 sm:px-3">
              <span className="hidden sm:inline">Recepción y almacenamiento</span>
              <span className="hidden xs:inline sm:hidden">Recepción</span>
              <span className="xs:hidden">Recepción</span>
            </TabsTrigger>
            <TabsTrigger value="calidad" className="text-xs sm:text-sm px-2 py-2 sm:px-3">
              <span className="hidden xs:inline">Calidad y producción</span>
