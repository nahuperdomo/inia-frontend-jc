  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const targetId = Number.parseInt(dosnId)        // Primero verificar que el ID existe en el listado
        try { const todosDosn = await obtenerTodasDosnActivas() => ({ id: d.analisisID, lote: d.lote })),
          )
...
// Ahora cargar los datos específicos del DOSN        const dosnData = await obtenerDosnPorId(targetId)        setDosn(dosnData)
