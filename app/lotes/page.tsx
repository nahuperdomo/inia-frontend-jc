...
import { Package, Search, Filter, Plus, Eye, Edit, Trash2, Download } from "lucide-react"
...
export default function LotesPage() {
  ...
  const [lotes] = useState<Lote[]>([
    ...
    },
    {
      ...
      estado: "Activo",
      pureza: 97.8,
      observaciones: "Lote ideal para ensayos de germinación",
    },
    {
      id: "RG-LE-ex-0024",
      empresa: "INIA",
      ...
      estado: "Activo",
      pureza: 98.9,
      observaciones: "Semillas de alta calidad para germinación",
    },
    {
      id: "RG-LE-ex-0025",
      empresa: "INIA",
      ...
      estado: "Activo",
      pureza: 96.5,
      observaciones: "Lote preparado para análisis múltiples",
    },
    {
      id: "RG-LE-ex-0026",
      empresa: "INIA",
      ...
      estado: "Activo",
      pureza: 97.3,
      observaciones: "Excelente para ensayos de germinación estándar",
    },
    {
      id: "RG-LE-ex-0027",
      empresa: "INIA",
      ...
      codigoCC: "CC010",
      codigoFT: "FT010",
      fechaRegistro: "2024-12-19",
      estado: "Activo",
      pureza: 95.7,
      observaciones: "Lote con condiciones óptimas de almacenamiento",
    },
  ])
  ...
  return (
    <div className="p-6 space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold text-balance">Gestión de Lotes</h1>
          <p className="text-muted-foreground text-pretty">
            Administra y consulta todos los lotes registrados en el sistema
          </p>
        </div>
